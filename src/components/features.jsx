                        ...
                        <div className="grid grid-cols-12 gap-4 justify-center">
                                ...
                                <div className="flex flex-col gap-4">
                                    ...
                                    <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                                        <p className="max-w-[460px]">
                                            Integrate your landing page directly
                                            in the product while using your
                                            favorite tools.
                                        </p>
                                    </div>
                                </div>
                            ...
                            >
                                <div className="flex flex-col gap-4">
                                    ...
                                    <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                                        <p className="max-w-[460px]">
                                            Blocks are available everywhere but
                                            ours are the best. Use them in your
                                            favorite framework or even in plain
                                            HTML.
                                        </p>
                                    </div>
                                </div>
                            ...
                            >
                                <div className="flex flex-col gap-4">
                                    ...
                                    <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                                        <p className="max-w-[460px]">
                                            Intelligent components that adapt to
                                            your needs with built-in animations
                                            and interactions.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <motion.div
                                ...
                                whileHover={{
                                    ...
                                    rotateX: 2,
                                    boxShadow:
                                        "0 20px 40px rgba(231, 138, 83, 0.3)",
                                    borderColor: "rgba(231, 138, 83, 0.6)",
                                }}
                                style={{ transition: "all 0s ease-in-out" }}
                            >
                                <div className="flex flex-col gap-4">
                                    ...
                                    <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                                        <p className="max-w-[460px]">
                                            Responsive layouts that transform
                                            and adapt seamlessly across all
                                            device sizes.
                                        </p>
                                    </div>
                                </div>
